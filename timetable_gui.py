...
class MasterWindow(tk.Tk):
    ...
    def create_widget(self):
        ...
        config_frame.grid(row=0, column=0, padx=padx, pady=pady, columnspan=3, rowspan=2, sticky='nesw')

        date_label = tk.Label(config_frame, text="날짜 입력")
        date_label.grid(row=0, column=0, padx=2, pady=2, sticky='nesw')

        date_entry = tk.Entry(config_frame, textvariable=self.date_value)
        date_entry.grid(row=0, column=1, padx=2, pady=2, sticky='nesw', columnspan=2)
        ...
        path_label.grid(row=1, column=0, padx=2, pady=2, sticky='nesw')

        path_entry = tk.Entry(config_frame, textvariable=self.output_directory)
        path_entry.grid(row=1, column=1, padx=2, pady=2, sticky='nesw')

        path_btn = tk.Button(config_frame, text="저장경로 설정", bg=path_button_color,
                             activebackground=path_button_color)
        path_btn.grid(row=1, column=2, padx=2, pady=2, sticky='nesw')

        button_frame = tk.Frame(self)
        button_frame.grid(row=2, column=0, padx=padx, pady=pady, columnspan=3, sticky='nesw')
        ...
        scrap_btn.grid(row=0, column=0, sticky='nesw', padx=2)
        ...
        exit_btn.grid(row=0, column=1, sticky='nesw', padx=2)

        log_frame = tk.Frame(self)
        log_frame.grid(row=3, column=0, padx=padx, pady=pady, columnspan=3, rowspan=4, sticky='nesw')
        ...
        progress_bar_frame.grid(row=7, column=0, padx=padx, pady=pady, columnspan=3, sticky='nesw')
